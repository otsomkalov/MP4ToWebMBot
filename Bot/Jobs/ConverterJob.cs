...
public class ConverterJob : IJob
{
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        try
        {
            ...
            var outputFileName = await _ffMpegService.ConvertAsync(inputFilePath);
            ...
            var uploaderMessage = new UploaderMessage(receivedMessage, sentMessage, inputFilePath, outputFileName,
                thumbnailFilePath);
